package com.ping.eureka.client.orderservice.controller;
...
public class OrderController {
    ...
    /**
     * http://localhost:8781/api/v1/order/save?userId=1&productId=1
     * @param userId
     * @param productId
     * @return
     */
    ...
    public Object findFallback(){
        Map<String, Object> data = new HashMap<>();
        data.put("code", 0);
//        data.put("data", productOrderService.findFallback(userId, productId));
        return data;
    }
